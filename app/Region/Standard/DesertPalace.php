...
class DesertPalace extends Region {
	...
	public function setVanilla() {
		...
		$this->locations["Desert Palace - Boss"]->setItem(Item::get('BossHeartContainer'));
	...
	public function initNoGlitches() {
		...
		$this->locations["Desert Palace - Boss"]->setRequirements(function($locations, $items) {
			return $this->canEnter($locations, $items)
				...
				&& (!$this->world->config('region.wildCompasses', false) || $items->has('CompassP2') || $this->locations["Desert Palace - Boss"]->hasItem(Item::get('CompassP2')))
				&& (!$this->world->config('region.wildMaps', false) || $items->has('MapP2') || $this->locations["Desert Palace - Boss"]->hasItem(Item::get('MapP2')));
