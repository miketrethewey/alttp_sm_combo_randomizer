...
/**
 * Super Metroid Visible Location
 */
class Visible extends Location {
	/**
	...
	public function writeItem(Rom $rom, Item $item = null) {
        ...
        $item_bytes = $item->getVisibleBytes();

        //foreach ($this->address as $key => $address) {
        //    if (!isset($item_bytes) || !isset($address)) continue;
        //    $rom->write($address, pack('C*', $item_bytes));
        //}
