...
class Item {
	...
	static public function all() {
		...
		static::$items = new ItemCollection([
			...
			new Item\SuperMetroid('Grapple', __('item.Grapple'), [0xB0], null, 0xef17, 0x54 + 0xef17, 0xa8 + 0xef17),
			new Item\SuperMetroid('XRay', __('item.XRay'), [0xB1], null, 0xef0f, 0x54 + 0xef0f, 0xa8 + 0xef0f),
			new Item\SuperMetroid('Varia', __('item.Varia'), [0xB2], null, 0xef07, 0x54 + 0xef07, 0xa8 + 0xef07),
			new Item\SuperMetroid('SpringBall', __('item.SpringBall'), [0xB3], null, 0xef03, 0x54 + 0xef03, 0xa8 + 0xef03),
			new Item\SuperMetroid('Morph', __('item.Morph'), [0xB4], null, 0xef23, 0x54 + 0xef23, 0xa8 + 0xef23),
			new Item\SuperMetroid('ScrewAttack', __('item.ScrewAttack'), [0xB5], null, 0xef1f, 0x54 + 0xef1f, 0xa8 + 0xef1f),
			new Item\SuperMetroid('Gravity', __('item.Gravity'), [0xB6], null, 0xef0b, 0x54 + 0xef0b, 0xa8 + 0xef0b),
			new Item\SuperMetroid('HiJump', __('item.HiJump'), [0xB7], null, 0xeef3, 0x54 + 0xeef3, 0xa8 + 0xeef3),
			new Item\SuperMetroid('SpaceJump', __('item.SpaceJump'), [0xB8], null, 0xef1b, 0x54 + 0xef1b, 0xa8 + 0xef1b),
			new Item\SuperMetroid('Bombs', __('item.Bombs'), [0xB9], null, 0xeee7, 0x54 + 0xeee7, 0xa8 + 0xeee7),
			new Item\SuperMetroid('SpeedBooster', __('item.SpeedBooster'), [0xBA], null, 0xeef7, 0x54 + 0xeef7, 0xa8 + 0xeef7),
			new Item\SuperMetroid('Charge', __('item.Charge'), [0xBB], null, 0xeeeb, 0x54 + 0xeeeb, 0xa8 + 0xeeeb),
			new Item\SuperMetroid('Ice', __('item.Ice'), [0xBC], null, 0xeeef, 0x54 + 0xeeef, 0xa8 + 0xeeef),
			new Item\SuperMetroid('Wave', __('item.Wave'), [0xBD], null, 0xeefb, 0x54 + 0xeefb, 0xa8 + 0xeefb),
			new Item\SuperMetroid('Spazer', __('item.Spazer'), [0xBE], null, 0xeeff, 0x54 + 0xeeff, 0xa8 + 0xeeff),
			new Item\SuperMetroid('Plasma', __('item.Plasma'), [0xBF], null, 0xef13, 0x54 + 0xef13, 0xa8 + 0xef13),
			new Item\SuperMetroid('ETank', __('item.ETank'), [0xC0], null, 0xeed7, 0x54 + 0xeed7, 0xa8 + 0xeed7),
			new Item\SuperMetroid('ReserveTank', __('item.ReserveTank'), [0xC1], null, 0xef27, 0x54 + 0xef27, 0xa8 + 0xef27),
			new Item\SuperMetroid('Missile', __('item.Missile'), [0xC2], null, 0xeedb, 0x54 + 0xeedb, 0xa8 + 0xeedb),
			new Item\SuperMetroid('Super', __('item.Super'), [0xC3], null, 0xeedf, 0x54 + 0xeedf, 0xa8 + 0xeedf),
			new Item\SuperMetroid('PowerBomb', __('item.PowerBomb'), [0xC4], null, 0xeee3, 0x54 + 0xeee3, 0xa8 + 0xeee3),
